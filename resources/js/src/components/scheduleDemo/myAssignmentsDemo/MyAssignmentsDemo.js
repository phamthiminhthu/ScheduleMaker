                        ...
                        <Col xs="12">
                            <Box sx={{ width: '100%', typography: 'body1' }}>
                                <TabContext value={value}>
                                    ...
                                    <TabPanel value="2"> <MyListAssignmentsDemo /></TabPanel>
                                    <TabPanel value="3"> <MyListAssignmentsDemo /></TabPanel>
                                    <TabPanel value="4"> <MyListAssignmentsDemo /></TabPanel>
                                    <TabPanel value="5"> <MyListAssignmentsDemo /></TabPanel>
                                    <TabPanel value="6"> <MyListAssignmentsDemo /></TabPanel>
                                    <TabPanel value="7"> <MyListAssignmentsDemo /></TabPanel>
                                    <TabPanel value="8"> <MyListAssignmentsDemo /></TabPanel>
